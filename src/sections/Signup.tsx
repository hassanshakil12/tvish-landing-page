...
const Signup = () => {
  ...
  return (
    <>
      <div className="w-full min-h-screen bg-linear-to-tl from-black via-black to-red-950 px-4 sm:px-6 lg:px-8 py-12 lg:py-20 relative overflow-hidden">
        {/* Animated Background Elements */}
        <div
          id="signup"
          className="absolute top-1/4 left-1/4 w-64 h-64 bg-red-600/5 rounded-full blur-3xl animate-pulse"
        ></div>
